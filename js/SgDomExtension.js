...
/* IE compatibility extension */

/***/

if (!window.getComputedStyle) {
	window.getComputedStyle=function(o,s) {
		var result={};
		for (var i in o.currentStyle) {
			result[i.fromCamelCase()] = o.currentStyle[i];
		}
		result.getPropertyValue=function(v) {
			return this[v];
		}
		return result;
	}
